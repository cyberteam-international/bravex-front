      ...
      <div className={styles.includedInner}>
        <div
          className={`${styles.includedHead} ${
            data.lightVersion ? styles.lightVersion : ""
          }`}
        >
          ...
          <div className={`${styles.includedHeadContent} fade-in`}>
            <p className={styles.includedHeadContentText}>{data.Description}</p>
            <Image src={LogoSVG} alt="" className={styles.logoHeader} />
          </div>
        </div>
              ...
              <div className={styles.includedBlockWrap}>
                <div className={`${styles.includedBlockRow} fade-in`}>
                  <div className={styles.includedBlockInfo}>
                    <p className={styles.includedBlockName}>
                      {block.Title || block.name}
                    </p>
                    <p className={styles.includedBlockText}>
                  ...
                  {block.Button ? (
                    <Button
                      ...
                      className={styles.includedBlockButton}
                    >
                      {block.Button.Text}
                    </Button>
                  ) : null}
